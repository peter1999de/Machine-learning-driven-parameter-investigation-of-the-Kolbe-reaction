...
#read input data
df_input = pd.read_csv('input_means.csv', index_col=0)
df_input = df_input.loc[:, :'21105-21107'] 
...
#filter input data
indices_to_remove_input = ['experimentalist', 'name main compund acid', 'SMILES main compound acid', 'name 2nd compound acid', 'SMILES 2nd compound acid', 'name 3rd compound acid', 'SMILES 3rd compound acid', 'time', 'cathode material', 'cathode area [cm^2 ]', 'anode material']
...
#filter output data
df_output = pd.read_csv('input_means.csv', index_col=0)
df_output = df_output.loc[:, :'21105-21107'] 
...
Y = filtered_output['Yalkane total acid [%]'].values
